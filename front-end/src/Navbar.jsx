...
function Navbar() {
    ...
    const handleSignOut = () => {
        ...
        const logoutUrl = `${process.env.REACT_APP_KEYCLOAK_URL}/realms/${
        ...
        <nav className="navbar navbar-expand-lg navbar-light bg-custom1">
            <div className="container-fluid">
                <Link to="/" style={{ textDecoration: "none", width: "150px" }}>
                    <img
                        src="https://fptplayboxdongnai.com/wp-content/uploads/2020/04/icon-home-cam-400x400.png"
                        alt="home"
                        width="50"
                        height="50"
                    />
                ...
                <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
                    <div className="d-flex align-items-center">
                        <span className="brand-name fs-6">
                            {" "}

...
public class EmailDesign {
    ...
    public String buildEmailBody(String userName, String dlProgram,String dlTask,String date) throws IOException {
        String emailTemplate = getEmailTemplateContent();
        emailTemplate = emailTemplate.replace("{{userName}}", userName);
        emailTemplate = emailTemplate.replace("{{dlProgram}}", dlProgram);
        emailTemplate = emailTemplate.replace("{{dlTask}}", dlTask);
